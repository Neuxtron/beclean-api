...
const DetailJadwalModel = require("./detail_jadwal_model")
...
const JadwalJemputModel = require("../jadwal_jemput/jadwal_jemput_model")
    ...
    try {
      const data = req.body
      const detailJadwal = await DetailJadwalModel.create(data)
  ...
  static async editDetailJadwal(req, res) {
    try {
      ...
      const detailJadwal = await DetailJadwalModel.findByPk(id)
